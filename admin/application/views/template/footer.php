<footer class="main-footer">
	<div class="pull-right hidden-xs">
		Page rendered in {elapsed_time} seconds - <b>Version</b> 1.0
    </div>
    <strong>Copyright &copy; <?= date('Y');?> <a href="#">Computer Base Test</a>.</strong> All rights reserved.
 </footer>
</div>
<!-- ./wrapper -->
...
<!-- Select2 -->
<script src="<?=base_url('./../assets/adminlte/bower_components/select2/dist/js/select2.min.js');?>"></script>
<!-- Slimscroll -->
