...
<div class="row">
  <div class="col-12">
    <div class="invoice-title">
      <h5 class="text-center m-b-30"><b>LAPORAN JADWAL UJIAN</b></h5>
        <?php $i = 0; foreach($cetak as $ujian) : ?>
        <?php if($i == 0) : ?>
        <p class="text-center m-b-30"><b>Periode <?= date('Y', strtotime($ujian->tanggal_mulai)); ?></b></p>
        <?php endif; ?>
        <?php $i++; ?>
        <?php endforeach; ?>      
      <br>
...
<table class="table table-sm">
    ...
    <tbody>
    <?php $no = 1; ?>
    <?php foreach($cetak as $ujian) : ?>
        <tr>
            <td class="text-center"><?= $no++; ?></td>
            <td><?= periode($ujian->tanggal_mulai). ' - '.date('H:i', strtotime($ujian->tanggal_selesai));?></td>
