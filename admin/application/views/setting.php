<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?=base_url('admin/tambah_admin');?>" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nip" class="form-control" placeholder="Masukkan NIP Admin">
                                            </div>
                                            <div class="form-group">
            ...
            <!--Ganti Password-->
            <div class="col-sm-6">
                <form action="<?=base_url('admin/ganti_user');?>" class="box box-purple" method="post">
                    <div class="box-header with-border">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="nip">NIP :</label>
                            <input type="text" name="nip" class="form-control" value="<?=$this->session->nip;?>" placeholder="Masukkan NIP">
                        </div>
                        <div class="form-group">
                            <label for="jabatan">Jabatan</label>
                            <select class="form-control" name="jabatan">
                                <option selected disabled>Pilih Jabatan</option>
                                <option value="Administrator" <?= $this->session->jabatan == 'Administrator' ? 'selected' : '' ?>>Administrator</option>
                                <option value="Kepala Sekolah" <?= $this->session->jabatan == 'Kepala Sekolah' ? 'selected' : '' ?>>Kepala Sekolah</option>
                            </select>
                        </div>                                                
                        <div class="form-group">
                            <label for="username">Username :</label>
            ...
            <div class="col-sm-6">
                ...
                <form action="<?=base_url('admin/ganti_passwd_admin');?>" class="box box-purple" method="post">
            <?php }
                if($this->session->status == 'guru'){ ?>
                <form action="<?=base_url('admin/ganti_passwd_guru');?>" class="box box-purple" method="post">
            <?php } ?>
                    <div class="box-header with-border">
