  ...
  <div class="col-12">
    <div class="invoice-title">
      <h5 class="text-center m-b-30"><b>LAPORAN DATA SISWA</b></h5>
        <?php $i = 0; foreach($cetak as $siswa) : ?>
        <?php if($i == 0) : ?>
          <h6 class="text-center m-b-30"><b>Tahun Ajaran <?= $siswa->tahun_ajaran; ?></b></h6>
        <?php endif; ?>
        <?php $i++; ?>
        <?php endforeach; ?>      
      <br>
...
<table class="table table-sm">
    ...
    <?php foreach($cetak as $siswa) : ?>
        <?php if($i == 0) : ?>
            <h6 class="text-left m-b-30"><b>Kelas : <?= $siswa->kode_kelas ?></b></h6>   
        <?php endif; ?>
        <?php $i++; ?>            
