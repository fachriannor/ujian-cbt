...
<head>
    ...
    <title>Laporan Nilai Siswa Kelas Guru</title>
</head>
<body>
<center>
    <table>
...
<div class="row">
  <div class="col-12">
    <div class="invoice-title">
      <h5 class="text-center m-b-30"><b>LAPORAN NILAI SISWA KELAS(GURU)</b></h5>
      <br>
    </div>
  </div>
</div>
<table class="table table-sm">
    ...
    <?php foreach($cetak_nilai_siswa as $nilai) : ?>
        ...
        <div class="row">
            ...
            <div class="col-5 text-right">
                <p class="text-left mb-1">Pengajar : <?= $nilai->nama_pengajar; ?></p>
            </div>
        ...
        <tr>
            ...
            <?php 
                $rata = 0;
                $rata = ($nilai->ulangan_1 + $nilai->ulangan_2 + $nilai->ulangan_3 + $nilai->uts + $nilai->uas) / 5 
            ?>
            <td><?= $rata ?></td>
        </tr>
    <?php endforeach; ?>
