        ...
        <?php if($i == 0) : ?>
            <div class="row">
                <div class="col-5 text-right">
                  <h6 class="text-left mb-1"><b>Mata Pelajaran : <?= $ls->nama_mapel; ?></b></h6>  
                </div>
                <div class="col-5 text-right">
                </div>
                <div class="col-2 text-right">
                <h6 class="text-left mb-1"><b>Kelas : <?= $ls->kode_kelas; ?></b></h6>
                </div>
                <div class="col-5 text-right">
                    <h6 class="text-left mb-1"><b>Kategori Soal : <?= $ls->kategori; ?></b></h6>
                </div>
                <div class="col-5 text-right">
                </div>
                <div class="col-2 text-right">
                <h6 class="text-left mb-1"><b>Jumlah Soal : <?= $total; ?></b></h6>
                </div>
            </div>
        <?php endif; ?>
        <?php $i++; ?>
